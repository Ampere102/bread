--[[
 ,gggggggggggggg                            ,ggg,         gg       ,a8a, 
dP""""""88""""""                  8I       dP""Y8a        88      ,8" "8,
Yb,_    88                        8I       Yb, `88        88      d8   8b
 `""    88                        8I        `"  88        88      88   88
     ggg88gggg                    8I            88        88      88   88
        88   8  ,gggg,gg    ,gggg,8I   ,ggg,    88        88      Y8   8P
        88     dP"  "Y8I   dP"  "Y8I  i8" "8i   88        88      `8, ,8'
  gg,   88    i8'    ,8I  i8'    ,8I  I8, ,8I   88        88 8888  "8,8" 
   "Yb,,8P   ,d8,   ,d8b,,d8,   ,d8b, `YbadP'   Y8b,____,d88,`8b,  ,d8b, 
     "Y8P'   P"Y8888P"`Y8P"Y8888P"`Y8888P"Y888   "Y888888P"Y8  "Y88P" "Y8
...
if _G.FadeUI_Loaded and _G.FadeUI then
    _G.FadeUI:Destroy()
end
...
_G.FadeUI = FadeUI.ScreenGui
for i,v in pairs({Name = "Template", Debug = false}) do
    if FadeUI.Settings[i] == nil then
        FadeUI.Settings[i] = v
    end
end

-- Intro --
function FadeUI.LoadingScreen()
    coroutine.wrap(function()
        local LoadingScreen = Utility.new("Frame", {
            Name = "LoadingScreen",
            Parent = FadeUI.ScreenGui,
        ...
        Utility.Wait(2.5)
        Services.ContentProvider:PreloadAsync({FadeUI.ScreenGui})
        Utility.Wait(0.25)
...
local function CreateOptions(Frame)
    ...
    function Options.Switch(Title, Callback)
        ...
        local Tweens = {
            [true] = {
                Utility.Tween(Container.Switch, TweenInfo.new(0.5), {BackgroundColor3 = FadeUI.ColorScheme.Primary}),
        ...
        local Container = Utility.new("ImageButton", {
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("ImageLabel", {
                    ...
                    Image = "rbxassetid://5028857472",
                    ImageColor3 = FadeUI.ColorScheme.Primary,
                    ScaleType = Enum.ScaleType.Slice,
                    SliceCenter = Rect.new(2, 2, 298, 298)
                }, {
                    Utility.new("Frame", {
...
function FadeUI.new(Name, Header, Icon)
    ...
    -- Window --
    local Window = {
        Title = Name and tostring(Name) or "FadeUI";
    ...
    function Window.Tab(Title, Icon)
        ...
        local TabButton = Utility.new("Frame", {
            Name = "Button",
            Parent = Main.SideBar,
            BackgroundColor3 = FadeUI.ColorScheme.Primary,
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
